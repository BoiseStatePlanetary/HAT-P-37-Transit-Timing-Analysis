...
def plot_data(file_name, color_dict):
    ...
    plt.errorbar(photdata["BJD_TDB"], photdata["flux"], yerr=photdata["error"], color='k', marker='none', ls='none', alpha=0.3)
    plt.plot(photdata["BJD_TDB"], photdata["flux"], color=color_dict[sector], marker=".", label=f"{planet_name} {sector}") 
