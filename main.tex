...
\include{fitted_transit_figures}

\begin{acknowledgments}
BJ, AK, DC, ERA, AS, and JPM were supported by a grant from the NASA Exoplanets Research Program, award number 80NSSC22K0317. MB was supported by the Idaho Space Grant Consortium. RMH was supported by the NASA Science Activation Program, award number 80NSSC22M0008. The authors acknowledge useful input from Rory Barnes and Eric Agol.
\end{acknowledgments}
